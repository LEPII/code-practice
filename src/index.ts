let sales: number = 123_456_789; // the underscores can make code/numbers more readable in Typescript
...
let lifter: {
  ...
  totalValid: (squatMax: number) => void;
    ...
    id: 1, name: "Luis", total: 400, goodLift: true, totalValid: (squatMax: number) => {
